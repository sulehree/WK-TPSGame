...
{
    [MenuItem("Invector/AI Controller/Create New AI", false, 0)]
    ...
    [MenuItem("Invector/AI Controller/Help/Forum")]
    public static void Forum()
    {
        Application.OpenURL("http://invector.proboards.com/");
    }

    [MenuItem("Invector/AI Controller/Help/Version: 0.1 Beta")]
    public static void Version()
    {
        Application.OpenURL("http://invector.proboards.com/board/23/ai-changelog");
    }

    [MenuItem("Invector/AI Controller/Help/Online Documentation")]
    public static void Documentation()
    {
        Application.OpenURL("http://www.invector.xyz/aidocumentation");
    }
    ...
    void Create()
    {
        ...
        if (instance)
        {
            ...
            (t as vIControlAI).CreateSecundaryComponents();
        }
        this.Close();
    }
