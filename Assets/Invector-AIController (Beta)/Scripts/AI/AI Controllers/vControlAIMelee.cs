...
namespace Invector.vCharacterController.AI
{
    ...
    public class vControlAIMelee : vControlAICombat, vIControlAIMelee, vIMeleeFighter
    {
        ...
        public bool isArmed { get { return MeleeManager != null ? MeleeManager.rightWeapon != null : false; } }
        ...
        public override void Attack(bool strongAttack = false, int _newAttackID = -1)
        {
            ...
            base.Attack(strongAttack, _newAttackID);
        }
