...
{    
    ...
    public class vStateDecisionEditor : Editor
    {
        ...
        {
            isOpen = GUILayout.Toggle(isOpen, new GUIContent(target.name, target.name), skin.GetStyle("FoldoutClean"), GUILayout.MaxWidth(200), GUILayout.Height(EditorGUIUtility.singleLineHeight));
