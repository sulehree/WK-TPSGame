    ...
    public static class vNodeUtility
    {
        ...
        public static void CreateNewGraph(string path)
        {
            ...
            if (curGraph != null)
            {
                ...
                entryNode.changeCurrentSpeed = false;
                ...
                anyState.changeCurrentSpeed = false;
        ...
        [MenuItem("Invector/AI Controller/Create New FSMBehaviour")]
        [MenuItem("Assets/Create/Invector/AI Controller/Create New FSMBehaviour")]
