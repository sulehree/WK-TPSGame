...
namespace Invector.vCharacterController.AI.FSMBehaviour
{
    public class vFSMNodeEditorWindow : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            // nodePropertyView.UpdateView(e,curGraph);
            // GUI.Box(dragFSMSize, "",skin.GetStyle("NodeDefault"));
            //GUI.Box(dragNodeProperySize, "", skin.GetStyle("NodeDefault"));
        ...
        void DrawToolStrip()
        {
            GUILayout.BeginHorizontal(skin.GetStyle("NodeDefault"), GUILayout.Height(toobarSize));
