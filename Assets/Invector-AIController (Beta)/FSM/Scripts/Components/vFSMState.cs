...
namespace Invector.vCharacterController.AI.FSMBehaviour
{
    ...
    public class vFSMState : ScriptableObject
    {
        ...
        public bool changeCurrentSpeed = true;
        [vHideInInspector("changeCurrentSpeed")]
        public vAIMovementSpeed customSpeed = vAIMovementSpeed.Walking;
        ...
        public virtual void OnStateEnter(vIFSMBehaviourController fsmBehaviour)
        {
            ...
            {
                fsmBehaviour.aiController.SetSpeed(customSpeed);
                fsmBehaviour.aiController.ForceUpdatePath(2);
            }               
