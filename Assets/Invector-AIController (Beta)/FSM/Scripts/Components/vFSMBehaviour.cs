...
namespace Invector.vCharacterController.AI.FSMBehaviour
{
    public sealed class vFSMBehaviour : ScriptableObject
    {
        ...
        public Color transitionTrueColor = Color.green;
        public Color transitionFalseColor = Color.red;
        ...
        void DrawNodeCurve(Rect start, Rect end, bool sideRight)
        {
            ...
            Vector3 endTan = endPos + (sideRight ? Vector3.left : Vector3.right) * (200 * magniture);
