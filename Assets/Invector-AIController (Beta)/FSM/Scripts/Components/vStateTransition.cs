...
namespace Invector.vCharacterController.AI.FSMBehaviour
{
    ...
    {       
        ...
        public vTransitionOutputType transitionType = vTransitionOutputType.True;
        //[vEnumFlag]
      ...
      //  public bool validate;
        ...
        { 
            ...
            if (val && trueState) returState= useTruState ? trueState : null;
            else if (!val && falseState) returState=  useFalseState ? falseState : null;
        ...
        {
           get { return (transitionType == vTransitionOutputType.Both || transitionType == vTransitionOutputType.True); }
        }
        public bool useFalseState
        {
            get { return (transitionType == vTransitionOutputType.Both || transitionType == vTransitionOutputType.False); }
        }
